function listarCasos() {
	...
	for (let i = 0; i < 100; i++) {
		...
		let valor1 = numeroString.substring(0, 2);
		let valor2 = numeroString.substring(2, 4);
		if (Number(valor1) + Number(valor2) == i) {
			todosOsCasos.push(i);
		}
	}
...
function addErro(areaParaResultados) {
	...
	pQualquer.innerHTML =
		"Atualize o código da função <code>listarCasos()</code> antes de rodar...";
